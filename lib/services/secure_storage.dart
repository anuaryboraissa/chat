...
class SecureStorageService {
  ...
  Future<void> writeModalData(Modal modal) async {
    await _secureStorage.write(
        ...
        aOptions: _getAndroidOptions());
    print("modal saved successfully to local storage.............");
  }
...
//read contacts
  ...
  Future<List> readMsgData(String key, String sender, String receiver) async {
    ...
    // print("my data .........................${datanew[5][7]}");

    // await deleteByKeySecureData("messages");r
